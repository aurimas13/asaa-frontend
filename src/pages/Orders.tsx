...
export const Orders: React.FC = () => {
  ...
  const getImageUrl = (images: string[] | string | null) => {
    if (!images) return 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=200&fit=crop&q=80'
    const parsed = typeof images === 'string' ? JSON.parse(images) : images
    return parsed[0] || 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=200&fit=crop&q=80'
  }
